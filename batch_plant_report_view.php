...
<!-- <?php
    ...
    for ($i=1; $i<=$total_pages; $i++) {  
                 $pagLink .= "<li><a href='batch_plant_report_view.php?page=".$i."'>".$i."</a></li>";  
    };  
    echo $pagLink . "</ul></nav>";  
?> -->
				</div>
				...
				<div class="col-md-8 col-md-offset-2">
					...
					<table class='table table-striped' style='width: 100%;' id='myTable'>
						<thead>
							...
							<tr class="filters">
								<th><input type="text" class="form-control" placeholder="Machine No." disabled></th>
		                        <th><input type="text" class="form-control" placeholder="Item" disabled></th>
		                        <th><input type="text" class="form-control" placeholder="Batch" disabled></th>
		                        <th><input type="text" class="form-control" placeholder="Total Cement(kg)" disabled></th>
		                        <th><input type="text" class="form-control" placeholder="Date" disabled></th>
							</tr>
							<!-- <tr>
								<th colspan='1'>
									<input type="text" id='select_date' name='select_date' class='form-control' onkeyup='myFunction();' placeholder="Search for date">
